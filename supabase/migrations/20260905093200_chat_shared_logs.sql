...
--
-- OWNERSHIP: these two tables belong to AI #1 (backend core). Column names here
-- mirror AI #1's canonical definition exactly (actor_type, not actor_kind), so
-- that when their migration runs first this file is a pure no-op. They are created
